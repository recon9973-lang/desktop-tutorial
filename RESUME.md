...
- **운영 판 = 0.3.523** (2026-09-07 02:28 KST 이중 실측 · 인구 이동 봉투 꼴 둘 + 0건 응답 앞부분 · 도장 끝) · 0.3.522 01:54 · 0.3.521 23:42 KST · 0.3.519 인구 이동 22:26 KST · 0.3.517·0.3.518 은 ANSEO 방
...
1. **인구 이동 첫 실호출 확정** — 열쇠는 들어감(2026-09-07 「데이터 원천」 캡처). 0.3.522 뒤 재개방 캡처가
   ...
   추정 → 0.3.523 이 두 꼴을 읽고 0건이면 응답 앞 300자를 화면에 적음. **다음 세션 첫 일**: 사장님이 0.3.523 에서
   다시 여신 「입지」 탭 캡처의 문장(응답 앞부분 300자) 으로 `location/population_move.py` 의
