# RESUME — 다음 세션 이어가기 (2026-09-07 20:20 KST · s20 · 0.3.535)
...
1-0. **0.3.537 (「탭 두 번 열기」 없앰) 뒤 첫 확인** — 사장님이 「입지」 를 한 번만 여시면, 아직 안 받은 축이 있을 때
...
1-0-1. **0.3.538 뒤 첫 확인** — 「입지」 를 **3km·5km·10km** 고리로 여시면 상권 상자가 이제 비지 않는다:
