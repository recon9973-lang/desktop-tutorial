...
- **운영 판 = 0.3.522** (2026-09-07 01:54 KST 이중 실측 · 인구 이동 실패 까닭 화면 표시 + Encoding 열쇠 풀기) · 0.3.521 문구 정정 23:42 KST · 0.3.519 인구 이동 22:26 KST · 0.3.517·0.3.518 은 ANSEO 방
...
1. **인구 이동 첫 실호출 확정** — 열쇠는 들어감(2026-09-07 「데이터 원천」 캡처 확인). 첫 실호출은 **실패**
   (참사랑한의원 · 창원 마산합포구 · 「방금 실패해 한 시간 뒤」) · 까닭 미상 → 0.3.522 가 까닭을 화면에 적음.
   사장님이 입지 탭을 다시 여시면 그 문장(응답 코드·본문 앞부분) 으로 `location/population_move.py` 의
