...
1. **진단 화면의 「정기 진단」 체크박스를 없앨까?**
   사장님 정의: **정기 = 자동(3일 간격 · 1·4·7…28일) / 일반 = 사람이 누른 1회성.**
   그런데 그 체크박스는 **사람이 누른 진단을 정기 기록에 넣는다** — 오늘 문제의 뿌리다.
   없애면 규칙이 한 줄이 된다: *자동으로 돈 것 = 정기 · 사람이 누른 것 = 일반.*
   집계·추이에 무엇이 들어가느냐를 바꾸는 일이라 **승인 없이 손대지 않았다.**
