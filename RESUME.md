# RESUME — 다음 세션 이어가기 (2026-09-07 06:10 KST · s20 + 0.3.527)

> 새 세션은 이 파일을 **먼저** 읽는다. 이 세션 상세는 `docs/session-logs/2026-09-06-s20.md`.

## 지금 상태

- **운영 판 = 0.3.527** (2026-09-07 06:04 KST 이중 실측 · 인구 이동 「자료 없음」(resultCode 3) 창은 빈 창 · 받은 달만 · 명세 전수 점검) · 0.3.526 04:37 · 0.3.525 03:52 · 0.3.524 03:15 · 0.3.523 02:28 · 0.3.522 01:54 · 0.3.521 23:42 KST · 0.3.519 인구 이동 22:26 KST · 0.3.517·0.3.518 은 ANSEO 방
...
1. **인구 이동 첫 실호출 확정** — 열쇠 인식됨(9/7). 0.3.523 캡처: `resultCode 11 · NO_MANDATORY_REQUEST_PARAMETERS_ERROR`
...
3. **「같은 과」 에 요양병원이 든 까닭 표시** — 사장님 질문(9/7 «요양병원이 왜 여기 있지?»): 심평원 등록 과목(한방과) 으로
   고르기 때문. 사장님 결정 대기: ⑴ 종별 다른 기관은 「같은 과 · 다른 종별」 로 갈라 세기 / ⑵ 표에 등록 과목 칸 추가(추천).
