...
- **운영 판 = 0.3.525** (2026-09-07 03:52 KST 이중 실측 · 인구 이동 응답 상한 64MB · 쪽 300행) · 0.3.524 03:15 · 0.3.523 02:28 · 0.3.522 01:54 · 0.3.521 23:42 KST · 0.3.519 인구 이동 22:26 KST · 0.3.517·0.3.518 은 ANSEO 방
...
1. **인구 이동 첫 실호출 확정** — 열쇠 인식됨(9/7). 0.3.523 캡처: `resultCode 11 · NO_MANDATORY_REQUEST_PARAMETERS_ERROR`
   ...
   쪽 300행. **다음 세션 첫 일**: 사장님이 0.3.525 에서 다시 여신 「입지」 탭 캡처 — 숫자면 끝(도장 · 데이터 원천
   줄 「시군구 1곳」 확인) · 문장이면 그 응답 앞부분으로 `location/population_move.py` 의
