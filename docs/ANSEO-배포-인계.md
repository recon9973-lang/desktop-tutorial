...
커밋     13개  a905da5 … e947748     (main 과의 차이)
분량     90파일 · +7,979 / −162
```
...
| `e947748` | **판 0.3.294** — changelog · `__version__` · openapi · 대장 |
...
git pull origin claude/anseo-ui-v3      # e947748 인지 확인
make deploy
```
...
> **아니라** 방이 덜 갖춰진 것이다 — §6 으로 PostgreSQL 을 먼저 켠다. 이 방에서도
> 세션이 바뀌자 꺼져 있었다.
