...
> 반영 판: veo-platform **v0.3.487** (17곳) (가지 `claude/anseo-screen-layout-optimization-ucs22y`, 배포 대기 표 등재 · **미배포**).
...
| 판 | 전: main 35aa51a(0.3.485) 빌드물 · 후: 이 가지(0.3.487) 빌드물 · 어두운 판 |
...
## 2. 결함표 — 찍어서 본 것 (전 = 0.3.485, 후 = 0.3.487)
...
- 배포는 **사장님 확인 후** — veo-platform `docs/WORKLIST.md` 배포 대기 표에 0.3.485(ANSEO 방)·0.3.487(이 판) 이 쌓여 있다.
