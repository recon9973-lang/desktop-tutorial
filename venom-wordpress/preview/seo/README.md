...
- ❌ 청킹·AI 전용 재작성 → **불필요**([39])
- 🟡 llms.txt → 구글 순위 요인은 아니나(리프트 미약속) 생성형 AI 안내용 **GEO 위생 신호로 소량(2점)** 반영 · /llms.txt 200+text 실측
- ✅ 대신 저자·조직·최신성·연락처·sameAs·**전화번호 구조화(JSON-LD telephone, GEO 3점)** = 실제 Google이 중시하는 신뢰/엔티티 신호
