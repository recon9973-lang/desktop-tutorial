...
## 최근 커밋 (8)
- 2026-09-26 가지 끝을 지금 것으로 모은다
- 2026-09-26 feat: 표 전부를 엑셀 한 권으로 묶는다 — 팀이 바로 열어 쓰게
- 2026-09-26 chore: PROJECT_STATE 자동 갱신 [skip ci]
- 2026-09-26 feat: 세종 인구를 공식 통로에서 받아 오는 단계 (#287)
- 2026-09-26 가지 끝을 지금 것으로 모은다(옛 기록은 이미 main 에 있다)
- 2026-09-26 feat: 세종 인구를 공식 통로에서 받아 오는 단계
- 2026-09-26 chore: PROJECT_STATE 자동 갱신 [skip ci]
...
---
*생성: 커밋 bfd82d6 기준. 값·비밀은 포함하지 않음.*
