...
- **저장소**: desktop-tutorial  ·  **현재 브랜치**: main-merge  ·  **기본 브랜치**: main-merge
- **이어갈 작업(RESUME)**: 이 가지(`main-merge`)에 짝이 없다 — 인계 10개 중 제 것을 찾아 «<!-- 가지: main-merge -->» 를 한 줄 달아라
...
---
*생성: 커밋 867e1910 기준. 값·비밀은 포함하지 않음.*
