...
v0.3.612  판을 물릴 때 이미 나간 항목·기록·줄에 손대지 않는다  ← 이번 회차 (배포 결과는 아래)
```

**다섯 판의 실서비스 확인이 끝났다** — [실측 2026-09-18 21:10 KST · 러너 「도는 판
...
2. **0.3.612 가 실제로 도는지**는 러너로 잰다 — Actions 의 「도는 판 확인」을
...
- **판 번호는 두 번 집혔다**(0.3.610·0.3.611 → 0.3.612). main 을 받아 온 뒤에는
