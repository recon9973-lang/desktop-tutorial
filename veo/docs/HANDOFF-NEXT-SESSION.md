...
> **이 장은 `docs/WORKLIST.md` 로 합쳤다(2026-08-09).** 결정된 것과 남은 것이 이 파일 ·
> `observation-engine.md` §9 · `PLAN-2026-08-total-review.md` §4 세 곳에 흩어져 있었고,
> 그래서 이미 확정된 관측 설계를 내가 다시 여쭙는 일이 생겼다(`CORRECTIONS.md` #22).
> **최신 목록은 `WORKLIST.md` 를 본다.** 아래는 그때의 기록으로 남긴다.
