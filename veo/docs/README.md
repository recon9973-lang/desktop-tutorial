...
## 4-A-1. 배포는 하루 2회까지 (2026-08 한정)

`make deploy` 가 세고 막는다. 넘으려면 환경변수를 직접 적어야 한다.

**왜** — 무료 Actions 2,000분을 8월 8일 만에 다 썼다. 전수 감사:
`docs/audit/2026-08-09-actions-minutes.md`. 요약하면 **2,155분 중 1,500분(70%)이
main 에서 같은 커밋을 재검사한 것**이었고 그건 없앴다. 남은 것으로도 하루 5회는
월 2,538분이라 2,000을 넘긴다. 하루 4회 이하면 무료 안이다.

`2026-09-01` 에 자동으로 풀린다.
...
| **무엇이든 — 확정·현황·날짜별·남은 것** | **`WORKLIST.md`** ← **여기부터.** 저장소를 뒤지기 전에 연다 |
